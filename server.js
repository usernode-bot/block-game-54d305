...
const PALETTE = [
  { id: 1,  name: 'Grass',         color: '#4a8a2d' },
  { id: 2,  name: 'Dirt',          color: '#6b4828' },
  { id: 3,  name: 'Stone',         color: '#6e6e73' },
  { id: 4,  name: 'Wood',          color: '#857d32' },
  { id: 5,  name: 'Leaves',        color: '#306f27' },
  { id: 6,  name: 'Sand',          color: '#aca26b' },
  { id: 7,  name: 'Brick',         color: '#7a3a2f' },
  { id: 8,  name: 'Glass',         color: '#7ca5b6', opacity: 0.45 },
  { id: 9,  name: 'Red',           color: '#a42e2e' },
  { id: 10, name: 'Blue',          color: '#2e55a3' },
  { id: 11, name: 'Yellow',        color: '#b19a2d' },
  { id: 12, name: 'White',         color: '#b9b9b9' },
  { id: 13, name: 'Snow',          color: '#aab9d9' },
  { id: 14, name: 'Gold Block',    color: '#c09b35', material: 'standard', metalness: 0.85, roughness: 0.2 },
  { id: 15, name: 'Glowstone',     color: '#cc8a32', emissive: '#cc6600', emissiveIntensity: 0.6 },
  { id: 16, name: 'Obsidian',      color: '#120621', material: 'standard', metalness: 0.3, roughness: 0.1 },
  { id: 17, name: 'Rainbow Block', color: '#cc356a', powerup: true },
  { id: 18, name: 'Crystal',       color: '#836bc7', opacity: 0.65, emissive: '#5f3aad', emissiveIntensity: 0.3, material: 'standard', metalness: 0.1, roughness: 0.2, unlockAt: 50, unlockIcon: '💎' },
];
