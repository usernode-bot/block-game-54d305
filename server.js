...
const PALETTE = [
  { id: 1,  name: 'Grass',         color: '#5fc23a' },
  { id: 2,  name: 'Dirt',          color: '#9c5f2e' },
  { id: 3,  name: 'Stone',         color: '#9aa0aa' },
  { id: 4,  name: 'Wood',          color: '#c08a3a' },
  { id: 5,  name: 'Leaves',        color: '#37b53c' },
  { id: 6,  name: 'Sand',          color: '#f0dd8a' },
  { id: 7,  name: 'Brick',         color: '#e0533a' },
  { id: 8,  name: 'Glass',         color: '#8fdcf0', opacity: 0.45 },
  { id: 9,  name: 'Red',           color: '#f23b3b' },
  { id: 10, name: 'Blue',          color: '#3a7bf0' },
  { id: 11, name: 'Yellow',        color: '#ffd91f' },
  { id: 12, name: 'White',         color: '#f4f4f8' },
  { id: 13, name: 'Snow',          color: '#cfe1ff' },
  { id: 14, name: 'Gold Block',    color: '#ffc83d', material: 'standard', metalness: 0.85, roughness: 0.2 },
  { id: 15, name: 'Glowstone',     color: '#ffb43d', emissive: '#ff7a00', emissiveIntensity: 0.6 },
  { id: 16, name: 'Obsidian',      color: '#1d0a3d', material: 'standard', metalness: 0.3, roughness: 0.1 },
  { id: 17, name: 'Rainbow Block', color: '#ff3d92', powerup: true },
  { id: 18, name: 'Crystal',       color: '#a585ff', opacity: 0.65, emissive: '#7a4dff', emissiveIntensity: 0.3, material: 'standard', metalness: 0.1, roughness: 0.2, unlockAt: 50, unlockIcon: '💎' },
];
